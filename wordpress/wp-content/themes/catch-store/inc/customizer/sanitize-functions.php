<?php
/**
 * Catch Store Theme Options Sanitization Functions
 *
 * @package Catch_Store
 */
 ...
 */
function catch_store_sanitize_select( $input, $setting ) {
 ...
 */
function catch_store_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catch_store_sanitize_post( $input ) {
 ...
 */
function catch_store_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function catch_store_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function catch_store_sanitize_number_range( $number, $setting ) {
