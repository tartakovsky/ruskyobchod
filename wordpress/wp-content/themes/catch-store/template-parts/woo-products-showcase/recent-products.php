...
$enable_content = get_theme_mod( 'catch_store_recent_products_showcase_option', 'disabled' );
...
$number         = get_theme_mod( 'catch_store_recent_products_showcase_number', 4 );
$columns        = 4;
$paginate       = false;
...
$title     = get_theme_mod( 'catch_store_recent_products_showcase_headline', esc_html__( 'Recent Products', 'catch-store' ) );
$sub_title = get_theme_mod( 'catch_store_recent_products_showcase_subheadline', esc_html__( 'Trending Fashion in this Season', 'catch-store' ) );
?>
