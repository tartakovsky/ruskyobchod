...
function gls_shipping_method_zones_init()
{
	if (!class_exists('GLS_Shipping_Method_Zones')) {
		class GLS_Shipping_Method_Zones extends WC_Shipping_Method
		{
			...
			public function __construct($instance_id = 0)
			{
				...
				$this->id                 = GLS_SHIPPING_METHOD_ZONES_ID;
...
add_action('woocommerce_shipping_init', 'gls_shipping_method_zones_init');