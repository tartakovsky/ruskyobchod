...
function tsseph_calculate_weight($post_id) {
    ...
    //If weight is not set in the order or in included items, check weigth from plugin settings
    if (empty($weight) && !empty($tsseph_options['ZakladnaHmotnost'])) {
        $weight = $tsseph_options['ZakladnaHmotnost'];
    }
...
function tsseph_init_new_vars($tsseph_options) {
    if (!isset($tsseph_options)) { $tsseph_options = []; }

    if (!isset($tsseph_options['UserId'])) { $tsseph_options['UserId'] = ''; } 
    if (!isset($tsseph_options['ApiKey'])) { $tsseph_options['ApiKey'] = ''; } 

    if (!isset($tsseph_options['PaymentType'])) { $tsseph_options['PaymentType'] = array('cod'); } 

    if (!isset($tsseph_options['OdosielatelID'])) { $tsseph_options['OdosielatelID'] = ''; } 
    if (!isset($tsseph_options['Meno'])) { $tsseph_options['Meno'] = ''; } 
    if (!isset($tsseph_options['Organizacia'])) { $tsseph_options['Organizacia'] = ''; } 
    if (!isset($tsseph_options['Ulica'])) { $tsseph_options['Ulica'] = ''; } 
    if (!isset($tsseph_options['Mesto'])) { $tsseph_options['Mesto'] = ''; } 
    if (!isset($tsseph_options['PSC'])) { $tsseph_options['PSC'] = ''; } 
    if (!isset($tsseph_options['Krajina'])) { $tsseph_options['Krajina'] = 'SK'; } 

    if (!isset($tsseph_options['Telefon'])) { $tsseph_options['Telefon'] = ''; }
    if (!isset($tsseph_options['Email'])) { $tsseph_options['Email'] = ''; } 
    if (!isset($tsseph_options['CisloUctu'])) { $tsseph_options['CisloUctu'] = ''; } 
    if (!isset($tsseph_options['TypEPH'])) { $tsseph_options['TypEPH'] = ''; } 
    if (!isset($tsseph_options['SposobUhrady'])) { $tsseph_options['SposobUhrady'] = ''; } 
    if (!isset($tsseph_options['Trieda'])) { $tsseph_options['Trieda'] = ''; } 

    if (!isset($tsseph_options['PodacieCisla'])) { $tsseph_options['PodacieCisla'] = array(
        '8' => array(),
        '14' => array()
    ); } 
    ...
    if (!isset($tsseph_options['PredvolenyDruhZasielky'])) { $tsseph_options['PredvolenyDruhZasielky'] = 1; } 
    ...
    if (!isset($tsseph_options['UloznaLehota'])) { $tsseph_options['UloznaLehota'] = 0; } 
    if (!isset($tsseph_options['ZakladnaHmotnost'])) { $tsseph_options['ZakladnaHmotnost'] = ''; } 
    if (!isset($tsseph_options['SposobSpracovania'])) { $tsseph_options['SposobSpracovania'] = 0; } 
    if (!isset($tsseph_options['PodacieCisla'][14]['RozsahPodCisFrom'])) { $tsseph_options['PodacieCisla'][14]['RozsahPodCisFrom'] = ''; } 
    if (!isset($tsseph_options['PodacieCisla'][14]['RozsahPodCisTo'])) { $tsseph_options['PodacieCisla'][14]['RozsahPodCisTo'] = ''; } 
    if (!isset($tsseph_options['PodacieCisla'][14]['AktualnePodCislo'])) { $tsseph_options['PodacieCisla'][14]['AktualnePodCislo'] = ''; } 
