        ...
        <div class="postbox">
            ...
            <div class="inside">	
                <table class="form-table" style="max-width:650px;">
                    ...
                    <tr>
                        <th><label for="tsseph_options[ZakladnaHmotnost]"><?php _e('Základná hmotnosť objednávky (kg)', 'spirit-eph'); ?>:</label></th>
                        <td><input name="tsseph_options[ZakladnaHmotnost]" type="text" style="width: 50px; text-align: right;" value="<?php esc_attr_e($tsseph_options['ZakladnaHmotnost']); ?>">
                            <div class="tooltip">
                                <span class="dashicons dashicons-info"></span>
                                <span class="tooltiptext">
                                    <?php _e('Vhodné vyplniť napríklad v prípade, kedy nemáte pri produktoch zadanú hmotnosť, no zároveň využívate ako spôsob úhrady "online (platobná karta)", ktorá hmotnosť vyžaduje.', 'spirit-eph'); ?>
                                </span>
                            </div>
                        </td>
                    </tr>			
