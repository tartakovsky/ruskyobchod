 ...
 * @return void
 */
function exactmetrics_ensure_cache_cleanup_scheduled() {
	...
	if ( ! wp_next_scheduled( 'exactmetrics_cache_daily_cleanup' ) ) {
		exactmetrics_schedule_cache_cleanup();
	}
}

// Hook into plugins_loaded with priority 20 to ensure cache functions are loaded first
add_action( 'plugins_loaded', 'exactmetrics_ensure_cache_cleanup_scheduled', 20 );
