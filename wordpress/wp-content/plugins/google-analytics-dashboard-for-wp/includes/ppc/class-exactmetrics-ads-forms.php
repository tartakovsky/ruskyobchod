	...
	public function __construct()
	{
		...
		if (! is_admin()) {
			...
			if ($this->conversionTrackingId) {
				add_action('exactmetrics_frontend_tracking_gtag_after_pageview', [$this, 'inject_form_conversion_tracking']);
			}
		}
	}
