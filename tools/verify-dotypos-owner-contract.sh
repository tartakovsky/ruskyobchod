...
REMOTE_SCRIPT="/tmp/rusky-verify-dotypos-owner-contract-$$.php"
...
scp -P "$REMOTE_PORT" "$ROOT_DIR/tools/verify-dotypos-owner-contract.php" "$REMOTE_HOST:$REMOTE_SCRIPT" >/dev/null
