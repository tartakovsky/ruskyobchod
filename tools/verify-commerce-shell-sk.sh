...
check_contains "$checkout_sk" 'Ulica' 'commerce checkout SK address label present'
check_contains "$checkout_sk" 'Názov ulice a číslo domu' 'commerce checkout SK address placeholder present'
...
check_contains "$checkout_sk" 'Poznámka k objednávke, napr\. upresnenie pre doručenie\.' 'commerce checkout SK order note placeholder present'
