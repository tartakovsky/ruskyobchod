...
check_contains "$checkout_ru" 'Банковский перевод' 'commerce checkout bank transfer present'
check_contains "$checkout_ru" 'Оплатите заказ прямым банковским переводом на наш счёт\. Заказ будет обработан после поступления оплаты\.' 'commerce checkout bank transfer description present'
